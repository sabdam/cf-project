...
<form name="form1" method="post" action= "editbug.cfm<cfoutput>?user_id=#user_id#?bug_id=#bug_id#</cfoutput>">
	...
	<table>
		<tr>
			<th>Unique number</th>
			<td><input type="text" name="unique_number" value="<cfoutput>#unique_number#</cfoutput>"></td>
		</tr>
		<tr>
			<th>Launch date</th>
			<td><input type="text" name="launch_date" value="<cfoutput>#launch_date#</cfoutput>"></td>
		</tr>
		<tr>
		...
		<tr>
			<th>Comment for history</th>
			<td><input type="text" name="comment" value="<cfoutput>#comment#</cfoutput>"></td>
		</tr>
	</table>
	<br>
...
<cfif IsDefined("form.bug_id") and IsDefined("form.comment") >
<!---	<cftry>--->
...
<cfif IsDefined("form.bug_id") and IsDefined("form.comment") >	
		...
		values (
			...
			<cfqueryparam cfsqltype="cf_sql_date" value="#form.launch_date#">,
